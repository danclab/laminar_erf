function [f_vals,wois]=invert_sliding_window(prior, data_file, coreg_fname, mri_fname, mesh_name, ...
    mesh_fname, nas, lpa, rpa, patch_size, n_temp_modes, win_size,...
    win_overlap, recompute_lgain)
...
[smoothkern]=spm_eeg_smoothmesh_mm(mesh_fname,patch_size);
